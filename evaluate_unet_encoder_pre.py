...
pretrained_weight_path = r'E:\pycharm_project\Huaxi_Yinjie_Jiang\Unet_encoder_weights_pre\epoch_35_68_67.pth'
...
def my_test(epoch):
    ...
    with torch.no_grad():
        ...
        # acc, Sen, Spe = cal_acc(0.285, all_out, all_label)
...
if __name__ == '__main__':
    ...
    dict_info = {"name": all_name, "label": label.tolist(), "Unet_pre_prob": test_out.tolist()}
    print(test_out)
    print(type(test_out))

    info = pd.DataFrame(dict_info)

    file_name = 'Unet_DL_pre_prob.xlsx'
