...
pretrained_weight_path = r'E:\pycharm_project\Huaxi_Yinjie_Jiang\AP_weights\epoch_40_733_703.pth'
...
if __name__ == '__main__':
    ...
    file_name = 'DL_prob%s.xlsx'%str(cohort_num)
    file_save_path = r'E:\Radiomics\huaxi_jiang_yinjie\outcome\cross_validation\cohorts\DL_prob'
