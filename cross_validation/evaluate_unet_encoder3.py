...
file_path = r'E:\Radiomics\huaxi_jiang_yinjie\outcome\cross_validation\cohorts\DL_prob\DL_path\cohort3.xlsx'
cohort_num = 3
...
pretrained_weight_path = r'E:\pycharm_project\Huaxi_Yinjie_Jiang\Unet_encoder_weights\epoch_105.pth'
...
if __name__ == '__main__':
    ...
    dict_info = {"name": all_name, "label": label.tolist(), "Unet_prob": test_out.tolist()}
    print(test_out)
    print(type(test_out))

    info = pd.DataFrame(dict_info)

    file_name = 'Unet_DL_prob%s.xlsx'%str(cohort_num)
    file_save_path = r'E:\Radiomics\huaxi_jiang_yinjie\outcome\cross_validation\cohorts\Unet_prob'
