...
for image_path, temp_label in zip(filenames, label):
    ...
    model.load_state_dict(
        torch.load(r'E:\pycharm_project\Huaxi_Yinjie_Jiang\Unet_encoder_weights\epoch_101_75_72.pth')
    )
    ...
    gray_path = 'E:\\Radiomics\\huaxi_jiang_yinjie\\cam\\Unet\\SRCC\\%s_gray_%s.png' % (ID, temp_label)
    color_path = 'E:\\Radiomics\\huaxi_jiang_yinjie\\cam\\Unet\\SRCC\\%s_cam_%s.png' % (ID, temp_label)
    ori_path = 'E:\\Radiomics\\huaxi_jiang_yinjie\\cam\\Unet\\SRCC\\%s_%s.png' % (ID, temp_label)
